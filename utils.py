...
# ==========================================
# Constants for Physical Properties & Materials
# ==========================================
MATERIAL_TO_CLASS = {
    "Wood": 0,
    "Metal": 1,
...
CLASS_TO_MATERIAL = {v: k for k, v in MATERIAL_TO_CLASS.items()}

# Statistics for Young's Modulus (E) and Poisson's Ratio (nu)
E_MEAN = 7.387210
E_STD = 2.456477
NU_MEAN = 0.398
NU_STD = 0.111
        ...
        for i, ckpt in enumerate(checkpoints):
            try:
                checkpoint = torch.load(
                    os.path.join(checkpoint_dir, ckpt), map_location="cpu"
                )
                del checkpoint
            except:
